<div class="container">
    <h2 class="text-uppercase fw-bold text-center" data-aos="fade-up">Call For <span class="secondary_color">Paper</span> </h2>
    <?php
    ...
    ?>
        <div class="row">
            ...
            <div class="col-md-6" data-aos="fade-up-left">
                ...
                <img src="Images/call_for_paper/<?php echo $image3 ?>" alt="cfp_2" class="img-fluid">
            </div>
            <div class="col-md-6" data-aos="fade-up-left">

                <img src="Images/call_for_paper/<?php echo $image4 ?>" alt="cfp_2" class="img-fluid">
            </div>
        </div>
