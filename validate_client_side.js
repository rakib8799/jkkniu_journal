...
function validatePreviousPassword() {
    ...
    innerHtml(previousPasswordErr, "Valid");
    previousPasswordErr.classList.remove('text-danger');
    previousPasswordErr.classList.add('text-success');
    return true;
}
...
function validateNewPassword() {
    ...
    innerHtml(newPasswordErr, "Valid");
    newPasswordErr.classList.remove('text-danger');
    newPasswordErr.classList.add('text-success');
    return true;
}
