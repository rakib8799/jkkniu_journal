...
if (isset($_POST['submit'])) {
    ...
    if (!in_array($path_info, $arr)) {
        echo "<p class='text-danger text-bold text-center fs-5 mt-3'>File Type Must be MS Word (DOC or DOCX)</p>";
    } else {
        $paper_id = time();
        ...
        if (mysqli_num_rows($run_select_from_new_paper) > 0) {
            ...
            if ($run_insert_qry) {
                move_uploaded_file($manuscript_pdf_file_tmp_name, '../Files/document_for_manuscript/' . $manuscript_pdf_file_name);

                // sent mail
                $receiver = $_SESSION['author_email'];
                $subject = "Confirmation of Paper Submission";
                $body = '<p>Dear Author(s),<br/>Thank you very much for uploading the following paper to the ICHSS-' . $current_year . ' submission system. We shall be in touch with you when the review of the paper will be completed.<br/><br/>
            <b>Manuscript ID:</b> ICHSS-' . $current_year . '-' . $_SESSION['author_id'] . '<br/>
            ...
            Best Regards,<br/>
            Dr. Jillur Rahaman Paul,<br/>
            Convener,<br/>
            3rd International Conference Committee &
            Associate Professor, <br/>
            Jatiya Kabi Kazi Nazrul Islam University,
            Trishal, Mymensingh-2224, Bangladesh <br/>
            E-Mail: <a href="ichss2024.jkkniu@gmail.com">ichss2024.jkkniu@gmail.com</a> <br/>
            Tel. +8801712574090 (WhatsApp)</p>';
