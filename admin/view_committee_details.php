                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><?php echo $committee_designation ?></td>
                                    <td><?php echo $committee_country ?></td>
                                    ...
                                    <td>
                                        <a href="edit_committee_details.php?committee_id=<?php echo $committee_id ?>" class="btn btn-primary">Edit</a>
                                    </td>
                                    <td>
                                        <a href="delete_committee_details.php?id=<?php echo $committee_id ?>&&image=<?php echo $committee_image; ?>" class="btn btn-primary" onclick="return confirmSubmission()">Delete</a>
                                    </td>
                                </tr>
                        <?php
                                $serial_no++;
