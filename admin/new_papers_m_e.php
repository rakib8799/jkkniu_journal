...
?>
        ...
        if ($run_update_paper_info) {
            for ($i = 0; $i < sizeof($all_reviewer_email); $i++) {
                ...
                $body = '<h5>Dear Sir/Madam, <br />' . $_SESSION['admin_name'] . 'has selected you to reviewe a paper. Please login into the site and review the paper when you have time.<br /> <br /> Best Regards, JKKNIU Journal Organization</h5>';
