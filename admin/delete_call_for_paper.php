...
<?php
if (isset($_GET['id'], $_GET['image1'], $_GET['image2'], $_GET['image3'], $_GET['image4'], $_GET['pdf_file'], $_GET['doc_file'])) {
    $id = $_GET['id'];
    $image1 = $_GET['image1'];
    $image2 = $_GET['image2'];
    $image3 = $_GET['image3'];
    ...
    if ($result) {
        ...
        unlink('../Images/call_for_paper/' . $image3);
        unlink('../Images/call_for_paper/' . $image4);
