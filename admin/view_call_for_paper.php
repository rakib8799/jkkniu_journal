                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><img src="../Images/call_for_paper/<?php echo $image3 ?>" width='50px' height='50px'></td>
                                    <td><img src="../Images/call_for_paper/<?php echo $image4 ?>" width='50px' height='50px'></td>
                                    ...
                                    <td>
                                        <a href="delete_call_for_paper.php?id=<?php echo $id ?>&&image1=<?php echo $image1; ?>&&image2=<?php echo $image2; ?>&&image3=<?php echo $image3; ?>&&image4=<?php echo $image4; ?>&&pdf_file=<?php echo $pdf_file; ?>&&doc_file=<?php echo $doc_file; ?>" class="btn btn-primary" onclick="return confirmSubmission()">Delete</a>
                                    </td>
                                </tr>
                        <?php
                                $serial_no++;
