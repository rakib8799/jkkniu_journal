            ...
            <div class="col-md-8 col-12">
                ...
                <form action="" method="post" onsubmit="return adminFormData()">
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder="Please type your name" value="<?php echo $admin_name; ?>" onkeyup="validateName()">
                        <span id="name_err" class="text-danger"></span>
                    </div>
                    <div class="mt-3">
                        <label for="email">Email</label>
                        <input type="email" name="email" id="email" class="form-control" placeholder="Please type your email address" value="<?php echo $admin_email; ?>" onkeyup="validateEmail()">
