        ...
        <div class="col-lg-12 col-12">
            <div class="card mt-2 shadow p-3 mb-5 bg-body rounded">
                <div class="card-header">
                    <h3 class="text-center text-secondary fw-bold">Inform Admin About Paper Review Completion</h3>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover text-center">
                            ...
                            <tbody>
                                ...
                                $select_from_new_paper = "SELECT * FROM `new_paper` WHERE `reviewer_id` = '$_SESSION[reviewer_id]' AND `paper_status` = '5' OR `paper_status` = '6'";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="view_paper_details_r.php?paper_id=<?php echo $row['paper_id'] ?>&r_id=<?php echo $row['reviewer_id'] ?>" class="btn btn-primary fw-bold">View Details</a></td>
                                        <?php
                                        ...
                                        ?>
                                            ...
                                            ?>
                                                ...
                                                <td>
                                                    <form action="" method="POST">
                                                        ...
                                                        <input type="submit" class="form-control btn btn-info fw-bold" name="inform_admin" value="Inform Admin">
                                                    </form>
                                                </td>
                                                <?php
                                            } else {
                                            ...
                                            if ($row['count'] == 1) {
                                            ?>
                                                <td class="informed_me fw-bold">Informed Admin</td>
                                                <td>--</td>
                                            <?php
                                            } else {
                                            ?>
                                                <td class="informed_me fw-bold">Informed Admin <br> (Re-submitted)</td>
                                                <td>--</td>
                                        <?php
                                            }
                                        }
...
<?php
if (isset($_POST['inform_admin'])) {
    $id_new_paper = $_POST['id_new_paper'];
    $paper_title = $_POST['paper_title'];
    // review kora ses ekhn admin ke inform korte hobe tai paper_status = 6 hobe
    $paper_status = 6;
    ...
    if ($run_update_paper_info) {
        ...
        $select_admin = "SELECT `admin_email` FROM `admin_information`";
        $run_select_admin = mysqli_query($conn, $select_admin);
        $res_select_admin = mysqli_fetch_assoc($run_select_admin);
        $admin_email = $res_select_admin['admin_email'];
...
?>
        <script>
            window.alert("A mail has been sent to Admin");
            window.location = "inform_admin.php";
        </script>
<?php
    }
}
