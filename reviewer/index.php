            ...
            <div class="card mt-2 shadow p-3 mb-5 bg-body rounded">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 mt-2">
                            <div class="card-body bg-primary text-white" style="border-radius: 8px;">
                                <h5><i class="fa-solid fa-address-book m-1"></i> Inform Admin</h5>
                                <?php
                                // select paper information
                                $select_from_new_paper = "SELECT * FROM `new_paper` WHERE  `paper_status` = '5' OR `paper_status` = '6'";
                                $run_select_from_new_paper = mysqli_query($conn, $select_from_new_paper);
                                $num_new_paper = 0;
                                while ($row = mysqli_fetch_assoc($run_select_from_new_paper)) {
                                    $all_reviewer_id = explode(",", $row['reviewer_id']);
                                ...
                                ?>
                                <a href="inform_admin.php" class="home_anker">Total Papers: <?php echo $num_new_paper ?></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-12 mt-2">
