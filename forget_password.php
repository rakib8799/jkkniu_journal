...
if (isset($_POST['submit_email'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // $body = "<p>Click On This Link to Reset Password <a href='http://3rd-ichss.jkkniu.edu.bd/reset_password.php?key=" . $author_email . "&reset=" . $author_password . "'>Reset Password</a></p>";
        $body = "<p>Click On This Link to Reset Password <a href='http://localhost/jkkniu_conference/reset_password.php?key=" . $author_email . "&reset=" . $author_password . "'>Reset Password</a></p>";
